...
export default class SideBar extends Component {
    ...
    render() {
       ...
       <div className="sidebar" style={{  background:" #FFF8DC",width: "220px",
  float: "left", height:"100%",  position: "fixed", top: 0, left: 0,backgroundColor:"white",zIndex:"1",
   overflowX:"hidden", boxShadow: "5px 10px 18px #888888", textAlign:"center"}} >
      <div>

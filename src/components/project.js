...
render(){
    return(
       <div>
            ...
            {/* <Navbar />
            <SideBar/> */}
            <div className="rectangle" style={{height: "480px",width: "1050px", backgroundColor: "white",marginTop:"80px",boxShadow: "0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.15)"}}>
